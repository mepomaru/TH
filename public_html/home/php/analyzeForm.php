        ...
        <div class="container">
            <div class="card">
                <from id="analyzeFrom" method="POST" action="">
                    ...
                    <h2>主観的に自分を分析する質問</h2>
                    <div>
                        <label for="core_values" class="card">
                    ...
                    <div>
                        <label for="accomplishment" class="card">
                    ...
                    <div>
                        <label for="core_values_repeat" class="card">
                    ...
                    <div>
                        <label for="compliment" class="card">
                    ...
                    <div>
                        <label for="challenge_feelings" class="card">
                    ...
                    <div>
                        <label for="ideal_self" class="card">
                    ...
                    <div>
                        <label for="future_self" class="card">
                    ...
                    <div>
                        <label for="contribution" class="card">
                    ...
                    <div>
                        <label for="life_priority" class="card">
                    ...
                    <div>
                        <label for="relationship_value" class="card">
                    ...
                    <div>
                        <label for="stress_management" class="card">
                    ...
                    <div>
                        <label for="happiness" class="card">
                    ...
                    <div>
                        <label for="adaptability" class="card">
